...
class _UpcommingPageState extends State<UpcommingPage> {
  ...
  void initState() {
    super.initState();
    context.read<MainProvider>().getUpcomingMovies();
  }
    ...
    return Consumer<MainProvider>(builder: (context, provider, child) {
     // provider.setIsLoad('loadAbout', false);
      ...
      return Builder(builder: (context) {
        if (provider.isLoad['loadUpcomming'] ?? false) {
          return Container(
            ...
            child: GridView.count(
              ...
              crossAxisCount: 2,
              children:
                  List.generate(provider.listUpcommingMovies.length, (index) {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => MovieDetailsPage(
                          provider.listUpcommingMovies[index],
                        ),
                      ),
                    );
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: NetworkImage(provider.listUpcommingMovies[index].posterPath!=null? 'https://image.tmdb.org/t/p/w500/${provider.listUpcommingMovies[index].posterPath}':'https://i.ibb.co/RPKnckW/ic-launcher-movies.png'),
                        fit: BoxFit.cover,
                      ),
                    ),
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          provider.listUpcommingMovies[index].originalTitle!,
